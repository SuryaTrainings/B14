		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Free style application",
									"targetURL": "#homeproject27-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"homeproject27-display": {
								"semanticObject": "homeproject27",
								"action": "display",
								"description": "Test FIORI App",
								"title": "UI5 Free style application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=home.project27",
									"url": sap.ui.require.toUrl("home/project27")
								}
							}
						}
					}
